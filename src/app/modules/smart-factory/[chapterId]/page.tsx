  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Learning Objectives */}
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 mb-8">
            ...
            {nextChapter ? (
              ...
              >
                <div className="text-right">
                  <div className="text-sm text-amber-100">다음 챕터</div>
